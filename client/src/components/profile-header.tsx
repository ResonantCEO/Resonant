...
export default function ProfileHeader({ profile, isOwn, canManageMembers, activeTab = "posts", setActiveTab }: ProfileHeaderProps) {
  ...
  return (
    <>
      {/* Profile Header */}
      <div className={`bg-white rounded-xl shadow-sm border border-neutral-200 mb-6 overflow-hidden ${profile.type === 'artist' ? 'h-32 sm:h-48' : 'min-h-[300px] sm:min-h-[340px]'}`}>
        {/* Cover Photo */}
