...
export default function ProfileHeader({ profile, isOwn, canManageMembers, activeTab = "posts", setActiveTab }: ProfileHeaderProps) {
  ...
  return (
    <>
      {/* Profile Header */}
      <div className={`bg-white rounded-xl shadow-sm border border-neutral-200 mb-6 overflow-hidden ${profile.type === 'artist' ? 'min-h-[275px] sm:min-h-[375px]' : ''}`}>
        {/* Cover Photo */}
        ...
        <div className={`p-4 sm:p-6 ${profile.type === 'artist' ? 'pt-8 sm:pt-4 pb-32 pl-32 sm:pl-52' : 'pt-6'} relative`}>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-end space-y-4 sm:space-y-0 sm:space-x-6">
            ...
            <div className="flex-1 mt-2 sm:mt-0">
              ...
              <div className="absolute bottom-0 sm:bottom-2 right-2 sm:right-4">
