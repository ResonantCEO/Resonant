        ...
        <div className={`p-4 sm:p-6 ${profile.type === 'artist' ? 'pt-6 sm:pt-2 pb-32 pl-32 sm:pl-52' : 'pt-6 pb-16 h-32 sm:h-48'} relative`}>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-end space-y-4 sm:space-y-0 sm:space-x-6">
            ...
            <div className={`flex-1 ${profile.type !== 'artist' ? '-mt-32 sm:-mt-40' : 'mt-2 sm:mt-0'}`}>
              ...
              {/* Booking Button - For venue profiles, visible only to artists */}
              {profile.type === 'venue' && viewerProfile?.type === 'artist' && (
                <div className={`absolute right-2 sm:right-4 ${profile.type === 'artist' ? '-bottom-8 sm:-bottom-8' : 'bottom-12 sm:bottom-12'}`}>
