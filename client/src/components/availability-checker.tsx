      ...
      .flatMap(request => {
        ...
        if (request.artistProfileId === artistProfileId || request.artistProfileId === venueProfileId) {
          events.push({
            ...
            profileImageUrl: request.artistProfile?.profileImageUrl || undefined
          });
        }
        ...
        if (request.venueProfileId === artistProfileId || request.venueProfileId === venueProfileId) {
          events.push({
            ...
            profileImageUrl: request.venueProfile?.profileImageUrl || undefined
          });
        }
      ...
      <DialogContent className="max-w-5xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-center space-x-8">
            ...
            <h3 className="text-lg font-medium min-w-[160px] text-center">
