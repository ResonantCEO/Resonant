      ...
      <div className={`bg-white rounded-xl shadow-sm border border-neutral-200 mb-6 overflow-hidden min-h-[240px] sm:min-h-[280px]`}>
        ...
        <div className={`p-4 sm:p-6 ${profile?.type === 'artist' ? 'pt-6 pb-16 pl-32 sm:pl-52' : 'pt-4 pb-20'} relative h-32 sm:min-h-[168px] md:min-h-[192px]`}>
          ...
          {profile?.type === 'venue' && !isOwn && activeProfile && activeProfile.type === 'artist' && (
            <div className="absolute right-2 sm:right-4 bottom-16 sm:bottom-16">
              <Button 
                variant="outline" 
                size="sm" 
                className="bg-blue-600 hover:bg-blue-700 text-white border-blue-600 text-xs sm:text-sm px-2 sm:px-3 min-w-[60px] sm:min-w-[80px] font-bold"
