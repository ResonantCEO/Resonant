  ...
  return (
    <>
      ...
      <div className={`bg-white rounded-xl shadow-sm border border-neutral-200 mb-6 overflow-hidden ${profile.type === 'artist' ? 'min-h-[275px] sm:min-h-[375px]' : 'min-h-[300px] sm:min-h-[340px]'}`}>
        ...
        {/* Profile Info */}
        <div className={`p-4 sm:p-6 ${profile.type === 'artist' ? 'pt-8 sm:pt-4 pb-32 pl-32 sm:pl-52' : 'pt-6 pb-16 h-32 sm:h-48'} relative`}>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-end space-y-4 sm:space-y-0 sm:space-x-6">
            ...
            {/* Profile Details */}
            <div className={`flex-1 ${profile.type !== 'artist' ? '-mt-24 sm:-mt-28' : 'mt-2 sm:mt-0'}`}>
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div className={`min-w-0 flex-1 ${profile.type !== 'artist' ? '-mt-28 sm:-mt-36' : ''}`}>
