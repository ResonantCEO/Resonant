        ...
        <div className={`p-4 sm:p-6 ${profile.type === 'artist' ? 'pt-8 sm:pt-4 pb-4 pl-32 sm:pl-52' : 'pt-6'} relative`}>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-end space-y-4 sm:space-y-0 sm:space-x-6">
            ...
            <div className="flex-1 mt-2 sm:mt-0">
              ...
              <div className={`flex items-center space-x-2 ${profile.type === 'artist' ? 'justify-center mt-4 pt-2 absolute left-1/2 transform -translate-x-1/2' : 'justify-center absolute bottom-4 left-0 right-0 pt-4'}`}>
                {/* Facebook */}
