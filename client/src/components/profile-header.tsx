...
export default function ProfileHeader({ profile, isOwn, canManageMembers, activeTab = "posts", setActiveTab }: ProfileHeaderProps) {
  ...
  return (
    <>
      {/* Profile Header */}
      <div className={`bg-white rounded-xl shadow-sm border border-neutral-200 mb-6 overflow-hidden ${profile.type === 'artist' ? 'min-h-[275px] sm:min-h-[375px]' : 'min-h-[240px] sm:min-h-[290px]'}`}>
        {/* Cover Photo */}
