  ...
  return (
    <div className="space-y-6">
      ...
      <Dialog open={!!selectedPhoto} onOpenChange={() => setSelectedPhoto(null)}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl border border-white/30 dark:border-gray-700/40 shadow-2xl rounded-2xl" hideOverlay={true}>
          {selectedPhoto && (
            <>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      const newTags = uploadFriendTags.filter((_, i) => i !== index);
                      setUploadFiles(newFiles);
                      setUploadCaptions(newCaptions);
                      setUploadFriendTags(newTags);
                    }}
                  >
                    <X className="w-4 h-4" />
                  </Button>
