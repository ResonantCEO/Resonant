  ...
  return (
    <div className="space-y-6">
      ...
      <Dialog open={!!selectedPhoto} onOpenChange={() => setSelectedPhoto(null)}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden backdrop-blur-xl bg-white/95 dark:bg-gray-900/95 border border-white/30 dark:border-gray-700/30 shadow-2xl rounded-2xl">
          {selectedPhoto && (
            <>
